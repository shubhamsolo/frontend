...
const Signup = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            // Send OTP instead of completing registration here
    ...
    const verifyOtpHandler = async (e) => {
        ...
        try {
            dispatch(setLoading(true));
            const res = await axios.post(`${USER_API_END_POINT}/verify-otp-and-register`, {
                ...input,
                otp,
            }, {
            ...
            <div className='flex items-center justify-center max-w-7xl mx-auto'>
                {!isOtpSent ? (
                    ...
                    <form onSubmit={verifyOtpHandler} className='w-1/2 border border-gray-200 rounded-md p-4 my-10'>
                        ...
                        <span className='text-sm'>
                            Didn’t receive an OTP? <button type='button' onClick={() => setIsOtpSent(false)} className='text-blue-600'>Resend</button>
                        </span>
                    </form>
                )}
            </div>
